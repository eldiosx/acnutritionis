...
const translations = {
    ...
    'Incluye 4 consultas por videollamada conmigo. Incluye todo lo referente al pack de inicio. Valoración exhaustiva de tus necesidades, herramientas nutricionales, plan personalizado etc.': 'Includes 4 video call consultations with me. It encompasses everything included in the starter pack: a comprehensive assessment of your needs, nutritional tools, and a personalized plan, among other things.',
    'Esta opción es para aquellas personas que no deseen escoger ningún pack o deseen continuar con el tratamiento tras la finalización de las sesiones del pack escogido. En cada consulta te proporcionaré toda la información que necesites en función de tu tratamiento, de forma personalizada e individualizada, además contarás con herramientas prácticas y teóricas que te ayudarán a lograr tus objetivos.':'This option is for those people who do not wish to choose any pack or wish to continue with the treatment after the sessions of the chosen pack have ended. In each consultation I will provide you with all the information you need based on your treatment, in a personalized and individualized way. You will also have practical and theoretical tools that will help you achieve your goals.',
